...
{
	/*the logic behind the function is it takes two inputs i.e. the start and end number. prints it, if it is dvisible by 2
    incremnts it and then using tail end recursion again passes onto itself.the exit condition being the if logical
	 structure*/
